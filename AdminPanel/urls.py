...
urlpatterns = [
    ...
    path("personel/add/", views.personel_add(), name="personel_add"),
    ...
    path("user/list/<int:page>/<int:per_page>/", views.user_list(), name="user_list"),
    path("category/", views.category_dashboard(), name="category"),
    path("weblog/list/", views.weblog_list(), name="weblog_list"),
    path("weblog/edit/<int:pk>/", views.weblog_edit(), name="weblog_edit"),
    path("weblog/add/", views.weblog_add(), name="weblog_add"),
    path("weblog/delete/", views.weblog_delete(), name="weblog_delete"),
