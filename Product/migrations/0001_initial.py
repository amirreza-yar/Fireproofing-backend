    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PN', 'در انتظار تایید'), ('PR', 'در حال آماده سازی'), ('SN', 'در حال ارسال'), ('RC', 'تحویل داده شده')], default='PN', max_length=2)),
                ...
                ('ordered_date', models.DateTimeField(verbose_name=datetime.datetime(2023, 1, 12, 8, 0, 44, 308774))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('expire_date', models.DateField(default=datetime.datetime(2023, 1, 26, 8, 0, 44, 309091))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
